...
print('DON')
DONar, DONar_std = range_analyzerptrc(start,end,'dissolved_organic_nitrogen')


ncname = 'DON_surf5m_050117_080117.nc'
...
print('SI')
SIar, SIar_std = range_analyzerptrc(start,end,'silicon')


ncname = 'SI_surf5m_050117_080117.nc'
f = nc.Dataset(ncname,'w', format='NETCDF4') #'w' stands for write
g = f.createGroup('surf_timeseries')
g.createDimension('stn',len(cs.STATIONS))
g.createDimension('time', days)
...
print('DIAT')
DIATar, DIATar_std = range_analyzerptrc(start,end,'diatoms')


ncname = 'DIAT_surf5m_050117_080117.nc'
f = nc.Dataset(ncname,'w', format='NETCDF4') #'w' stands for write
g = f.createGroup('surf_timeseries')
g.createDimension('stn',len(cs.STATIONS))
g.createDimension('time', days)
