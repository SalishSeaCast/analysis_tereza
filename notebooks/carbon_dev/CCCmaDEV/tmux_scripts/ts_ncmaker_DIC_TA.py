...
print('TA')
TAar, TAar_std = range_analyzer(start,end,'total_alkalinity')


ncname = 'TA_surf5m_050117_080117.nc'
...
print('DIC')
DICar, DICar_std = range_analyzer(start,end,'dissolved_inorganic_carbon')


ncname = 'DIC_surf5m_050117_080117.nc'
f = nc.Dataset(ncname,'w', format='NETCDF4') #'w' stands for write
g = f.createGroup('surf_timeseries')
g.createDimension('stn',len(cs.STATIONS))
g.createDimension('time', days)
