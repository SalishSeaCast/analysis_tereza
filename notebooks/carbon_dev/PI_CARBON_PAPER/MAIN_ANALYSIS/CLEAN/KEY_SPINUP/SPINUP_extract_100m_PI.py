...
ncname = 'PI_BC_2015_100m_massbal_comparison.nc'
start1 = '2015-01-01'
end1 = '2015-12-31'
st = dt.datetime(2015,1,1)
en = dt.datetime(2015,12,31)

#sdir 1 is the spinup year
sdir_1 = '/data/tjarniko/results/BASERUN_EXP/NOT_MAIN_ANALYSIS/PI_2nd_2015/ncs/'
#sdir 2 is the year you're testing whether is spunup
sdir_2 = '/data/tjarniko/results/BASERUN_EXP/MAIN/PI_3rd_2015/ncs/'
