...
import pickle
pickle.dump(BR_sums_perday, open("BR_sums_perday_fU.pkl", 'wb'))
...
pickle.dump(LA_sums_perday, open("LA_sums_perday_fU.pkl", 'wb'))
...
pickle.dump(PI_sums_perday, open("PI_sums_perday_fU.pkl", 'wb'))
