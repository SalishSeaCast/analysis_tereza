def two_panel_plot(surfdat_1,surfdat_2,tit1,tit2,t_cmap,xsize,ysize,v_min1,v_max1,v_min2,v_max2,clabel,bigtit):
    "TESTED"
...
def nice_CN_plot(tit1, tit2, plotdat, physdat, t, v_min, v_max, tcmap, clabel):
    ...
    import cmocean
    import glob
    fig, (axl, axr) = plt.subplots(1, 2, figsize=(13, 8 ))
