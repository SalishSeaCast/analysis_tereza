...
PI_DIC_apr = np.zeros([nd,40,898,398])
PI_TA_apr = np.zeros([nd,40,898,398])
PI_T_apr = np.zeros([nd,40,898,398])
PI_S_apr = np.zeros([nd,40,898,398])
#
BR_DIC_apr = np.zeros([nd,40,898,398])
BR_TA_apr = np.zeros([nd,40,898,398])
BR_T_apr = np.zeros([nd,40,898,398])
BR_S_apr = np.zeros([nd,40,898,398])
#
