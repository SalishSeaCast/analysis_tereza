...
PI_DIC_aug = np.zeros([nd,40,898,398])
PI_TA_aug = np.zeros([nd,40,898,398])
PI_T_aug = np.zeros([nd,40,898,398])
PI_S_aug = np.zeros([nd,40,898,398])
#
BR_DIC_aug = np.zeros([nd,40,898,398])
BR_TA_aug = np.zeros([nd,40,898,398])
BR_T_aug = np.zeros([nd,40,898,398])
BR_S_aug = np.zeros([nd,40,898,398])
#
