...
for ind in range(startind,endind):
    ...
    test_LO = nc.Dataset('/results/forcing/LiveOcean/boundary_conditions/LiveOcean_v201905_' + year_ar[ind])
    ...
    f = nc.Dataset('./preind_DIC/LO' + year_ar[ind] +'_preind_DIC.nc','w', format='NETCDF4') #'w' stands for write
