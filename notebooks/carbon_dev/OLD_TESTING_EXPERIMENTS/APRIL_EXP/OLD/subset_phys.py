...
# subprocess.call('ncks -v vozocrtx SKOG_1h_20160301_20160315_grid_U.nc u_1h.nc', shell=True,cwd=resdir)
# print('u')
# subprocess.call('ncks -v time_counter SKOG_1h_20160301_20160315_grid_U.nc timecount_1h.nc', shell=True,cwd=resdir)
# print('t')
# subprocess.call('ncks -v vomecrty SKOG_1h_20160301_20160315_grid_V.nc v_1h.nc', shell=True,cwd=resdir)
# print('v')
...
subprocess.call('ncks -v vozocrtx SKOG_1d_20160415_20160429_grid_U.nc u_1d.nc', shell=True,cwd=resdir)
print('u')
subprocess.call('ncks -v time_counter SKOG_1d_20160415_20160429_grid_U.nc timecount_1d.nc', shell=True,cwd=resdir)
print('t')
subprocess.call('ncks -v vomecrty SKOG_1d_20160415_20160429_grid_V.nc v_1d.nc', shell=True,cwd=resdir)
print('v')
