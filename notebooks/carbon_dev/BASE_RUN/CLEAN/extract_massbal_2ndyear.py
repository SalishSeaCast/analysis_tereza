...
ncname = 'BR2015_2ndyr_massbal_to1026.nc'
...
ncname = 'PI2015_2ndyr_massbal_to1026.nc'
f = nc.Dataset(ncname,'w', format='NETCDF4') #'w' stands for write
g = f.createGroup('model_output')
#g.createDimension('days', len(NO3_mod))
g.createDimension('days', days_in)
ts = g.createVariable('stor_mol_PI','f4',('days'))
ts[:] = stor_mol_PI
ts2 = g.createVariable('stor_mol_surf_PI','f4',('days'))
