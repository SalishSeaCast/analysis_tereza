...
yr = 2016
yrday = 366
trans_DIC_2016_mol_per_gridcell = np.zeros([366,40,75])
anom_DIC = 2050
tnam = f"trans_anomDIC_{anom_DIC}_2016_mol_per_gridcell.pkl"
...
for i in range(0,366):
    ...
    trans_DIC_2016_mol_per_gridcell[i,:,:] = C_day
    

pickle.dump(trans_DIC_2016_mol_per_gridcell, open(tnam, 'wb'))