...
yr = 2014
yrday = 365
trans_DIC_2014_mol_per_gridcell = np.zeros([365,40,75])
anom_DIC = 2050
tnam = f"trans_anomDIC_{anom_DIC}_2014_mol_per_gridcell.pkl"
...
for i in range(0,365):
    ...
    trans_DIC_2014_mol_per_gridcell[i,:,:] = C_day
    

pickle.dump(trans_DIC_2014_mol_per_gridcell, open(tnam, 'wb'))