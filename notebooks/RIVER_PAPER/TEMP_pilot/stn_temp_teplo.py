...
fname = pkldir + 'TEPLO_temp_means_cs2_BOX'
y = cs2_y; x = cs2_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )
fname = pkldir + 'TEPLO_temp_means_cs_BOX'
y = cs_y; x = cs_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )
fname = pkldir + 'TEPLO_temp_means_cs3_BOX'
y = cs3_y; x = cs3_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )
fname = pkldir + 'TEPLO_temp_means_haro2_BOX'
y = haro2_y; x = haro2_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )
fname = pkldir + 'TEPLO_temp_means_haro_BOX'
y = haro_y; x = haro_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )
fname = pkldir + 'TEPLO_temp_means_haro3_BOX'
y = haro3_y; x = haro3_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )
fname = pkldir + 'TEPLO_temp_means_jdf2_BOX'
y = jdf2_y; x = jdf2_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )
fname = pkldir + 'TEPLO_temp_means_jdf_BOX'
y = jdf_y; x = jdf_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )
fname = pkldir + 'TEPLO_temp_means_jdf3_BOX'
y = jdf3_y; x = jdf3_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )
fname = pkldir + 'TEPLO_temp_means_ns2_BOX'
y = ns2_y; x = ns2_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )
fname = pkldir + 'TEPLO_temp_means_ns_BOX'
y = ns_y; x = ns_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )
fname = pkldir + 'TEPLO_temp_means_ns3_BOX'
y = ns3_y; x = ns3_x
ebmBOX.extractor(start, end, ftype, sdir, varname, fname, y, x )