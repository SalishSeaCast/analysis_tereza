...
#### get preformed pco2 and target year preformed pco2
    ...
    f = nc.Dataset(f'./JdF_future_DIC/LO_targetyear_{target_year}_scenario_{scen}_{ymd}_DIC.nc','w', format='NETCDF4') #'w' stands for write
...
def func1():
  ...
  for i in range(0,60):
        calc_preind_co2_AOU_method(arrow_array[i][0], 2016, 2050, '2_4pt5')
