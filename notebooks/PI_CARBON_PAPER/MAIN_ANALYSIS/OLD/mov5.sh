...
avconv -framerate 4 -f image2 -i m${PAT}%05d.png -qscale 1 movie_${PAT}.mp4
#avconv -framerate 6 -f image2 -i m${PAT}%05d.png movie_${PAT}.mp4i
#avconv -framerate 6 -i m${PAT}%05d.png movie_${PAT}.mp4
