...
def find_oma_depths_via_amax(Omega_A_ar, zlevels):
...
for day in range(0,365):
    ...
    oma_dep_PI = find_oma_depths_via_amax(OmA_PI_test,zlevels)
    oma_dep_BR = find_oma_depths_via_amax(OmA_BR_test,zlevels)
    oma_d_PI[day,:,:] = oma_dep_PI
    oma_d_BR[day,:,:] = oma_dep_BR
    

f = nc.Dataset('OmA_horizon_2015.nc','w', format='NETCDF4') #'w' stands for write
